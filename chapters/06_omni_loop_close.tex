...
In order to compensate for outliers, first a robust mean is calculated using Jonsson's\cite{jonsson_05} robust mean algorithm.  Outliers can then be identified by comparing them with the robust mean and removed from the list. To deal with the depth uncertainty of points, a weighted average is calculated as follows:
