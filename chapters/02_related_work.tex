...
Point triagulation is the task of estimating the location of a point, given two or more views of that point, and the transformations between those views.  Jonsson\cite{jonsson_05} has a well established algorithm for solving this problem.
